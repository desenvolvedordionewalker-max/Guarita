...
export const initialRanking: Ranking = {
  ...
  mes: 1240,
  drivers: [
    { pos: 1, name: "João Silva", placa: "ABC-1234", rolos: 24, viagens: 3, status: "normal" },
    { pos: 2, name: "Marcos Lima", placa: "DEF-5678", rolos: 20, viagens: 4, status: "lenta" },
    { pos: 3, name: "Ana Costa", placa: "GHI-9012", rolos: 18, viagens: 2, status: "atrasada" },
  ],
};

export const initialGestao: GestaoItem[] = [
  {
    placa: "ABC-1234",
    motorista: "João Silva",
    viagens: [
      { title: "1ª Viagem", lavoura: "12m", algodoeira: "8m", total: "20m", status: "normal", when: new Date().toISOString() },
      { title: "2ª Viagem", lavoura: "22m", algodoeira: "12m", total: "34m", status: "lenta", when: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString() },
    ],
  },
  {
    placa: "DEF-5678",
    motorista: "Marcos Lima",
    viagens: [{ title: "1ª Viagem", lavoura: "30m", algodoeira: "10m", total: "40m", status: "atrasada" }],
  },
];
